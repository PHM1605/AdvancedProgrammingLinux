...
#define FILE_MODE (S_IRUSR | S_WRUSR | S_IRGRP | S_IROTH)

// Default file access permissions for new directories
...
#define readw_lock(fd, offset, whence, len) lock_reg((fd), F_SETLKW, F_RDLCKW, (offset), (whence), (len))
...
#define is_write_lockable(fd, offset, whence, len) (lock_test((fd), F_WRLCK, (offset), (whence), (le)) == 0)
